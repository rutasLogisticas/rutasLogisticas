-- Script para configurar UTF-8 en MySQL - Versión mejorada
...
DELETE FROM clients WHERE name LIKE '%José%' OR name LIKE '%María%' OR name LIKE '%Álvaro%';

-- Insertar datos de prueba con caracteres especiales correctamente
